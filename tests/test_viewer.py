...
def test_video_dir():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        base_dir = tmpdir / "base" / "test-platform_opt" / "browsertime-test" / "task123" / "browsertime-videos-original"
        base_dir.mkdir(parents=True)

        new_dir = tmpdir / "new" / "test-platform_opt" / "browsertime-test" / "task456" / "browsertime-videos-original"
...
class TestViewerApp:
    ...
    def test_video_route(self, client, test_video_dir):
        ...
        video_path = "base/test-platform_opt/browsertime-test/task123/browsertime-videos-original/video1.mp4"
